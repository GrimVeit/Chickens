...
public class Slots4SceneEntryPoint : MonoBehaviour
{
    [SerializeField] private Sounds sounds;
    [SerializeField] private Combination combinations;
    [SerializeField] private BetAmounts betAmounts;
    [SerializeField] private UISlots4SceneRoot sceneRootPrefab;

    private UISlots4SceneRoot sceneRoot;
    ...
    public void Run(UIRootView uIRootView)
    {
        ...
        slotMachinePresenter = new SlotMachinePresenter
            (new SlotMachineModel(5, 3, combinations, betAmounts, bankPresenter, soundPresenter, particleEffectPresenter),
    ...
    //{
    //    add { sceneRoot.GoToMainMenu += value; }
    //    remove { sceneRoot.GoToMainMenu -= value; }
    //}
